 ...
 */
package adv17w_fw.test_util.scenario_test;
...
import adv17w_fw.test_util.ATester;
import adv17w_fw.test_util.common.TestException;
import adv17w_fw.test_util.common.TestUtilitiy;
...
//\IM== INSTANCE REMAINING NON-PRIVATE METHODS =================================
    ...
    <li>Umí vrátit správně naformátované jméno autora/autorky hry
       a jeho/její xname.</li><li>Definuje základní úspěšný a základní chybový scénář.</li><li>Základní chybový scénář má následující vlastnosti:</li>
       <li>Startovní příkaz, jehož název je prázdný řetězec</li><li>Minimální požadovaný počet kroků</li><li>Minimální počet navštívených místností</li><li>Minimální počet "zahlédnutých" místností</li><li>Použití příkazů pro přechod z prostoru do prostoru
         zvednutí nějakého objektu a položení nějakého objektu</li><li>Základní chybový scénář má následující vlastnosti:</li>

       <li>Startovní příkaz, jehož název je prázdný řetězec</li><li>Použití všech povinných chybových typů kroku
         definovaných ve třídě
         {@link adv17w_fw.scenario.TypeOfStep}</li><li>Vyvolání nápovědy</li><li>Ukončení příkazem pro nestandardní ukončení hry
      </li></ul>
     * @return summary of the test
     */
